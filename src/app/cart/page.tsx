            ...
            <div className="layout-container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-7 flex flex-col pt-2">
                        ...
                        <Link
                            href="/shop"
                            className="inline-flex items-center gap-2 text-[13px] font-bold text-melon hover:text-charcoal transition-colors mb-4 group"
                        >
                            <span className="w-7 h-7 rounded-full bg-melon/10 flex items-center justify-center group-hover:bg-melon/20 transition-colors">
